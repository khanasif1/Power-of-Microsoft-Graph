...
namespace sample.graph.fnApp.config
{
    ...
    public class AuthenticationConfig
    {
        ...
        /// <summary>
        /// Service Bus connection string and queue name
        /// </summary>
        ...
        public AuthenticationConfig()
        {
            ...
            this.SBconnectionString = System.Environment.GetEnvironmentVariable("AADSYNC_SERVICEBUS", EnvironmentVariableTarget.Process);
            this.SBQueueName = System.Environment.GetEnvironmentVariable("invitequeue", EnvironmentVariableTarget.Process);            
